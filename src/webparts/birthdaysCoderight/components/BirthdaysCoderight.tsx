...
const BirthdaysCoderight: React.FunctionComponent<IBirthdaysCoderightProps> = (props:IBirthdaysCoderightProps) => {
  const {
    description,
    isDarkTheme,
    environmentMessage,
...
export default BirthdaysCoderight;
/* export default class BirthdaysCoderight extends React.Component<IBirthdaysCoderightProps, {}> {
  public render(): React.ReactElement<IBirthdaysCoderightProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
