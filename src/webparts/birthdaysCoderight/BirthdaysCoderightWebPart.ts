...
export default class BirthdaysCoderightWebPart extends BaseClientSideWebPart<IBirthdaysCoderightWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IBirthdaysCoderightProps> = React.createElement(
      BirthdaysCoderight,
      {
